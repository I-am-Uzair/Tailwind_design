...
const Hero = () => {
  const [showMobileMenu, setShowtMobileMenu] = useState(false);
  return (
    <div
    ...
    >
      <div className="relative w-full max-w-[1490px] flex items-center justify-between pt-10 mx-auto px-10">
        ...
        <HiMenuAlt3
          ...
          onClick={() => setShowtMobileMenu((prev) => !prev)}
        />
        <div
        ...
        >
          <AiOutlineClose
            ...
            onClick={() => setShowtMobileMenu(false)}
          />
          <ul className="flex flex-col items-center pt-[60px] gap-8">
            ...
            <NavLink to="Referrnce" mobileMenu>
              Reference
            </NavLink>
          ...
          <img
            src={cartIcon}
            alt="Shooping cart"
            className="my-10 mx-auto cursor-pointer"
          />
        </div>
      </div>
      ...
      <FadeIn delay={0.4} direction="down" padding fullWidth>
        <h1 className="mt-6 text-center text-lg  xs-text-[64px] text-white max-w-[500px ]:">
          {heroSubtitle}
        </h1>
      </FadeIn>
      ...
      <FadeIn delay={0.4} direction="up" padding fullWidth>
        <div className="relative w-full xs:w-[460px] mt-11">
          <input
            type="text"
            placeholder="Search"
            className="rounded-full w-full pl-6 pr-[68px] py-4 bg-primary outline-none text-white text-base placeholder-white"
          />
          <img
            src={searchIcon}
            alt="Search Icon"
